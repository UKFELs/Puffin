...
subroutine rk4par(tScaling, sZ, h, qD)
...
!    Get derivatives
  ...
  call derivs(tScaling, sZ, A_localtr0, A_localti0, &
...
!    Get derivatives
  ...
  if (qPArrOK_G) &
    call derivs(tScaling, szh, A_localtr1, A_localti1, &
...
!    Get derivatives
  ...
  if (qPArrOK_G) &
    call derivs(tScaling, szh, A_localtr2, A_localti2, &
       xt, yt, z2t, pxt, pyt, pz2t, &
...
!    Get derivatives
  ...
  if (qPArrOK_G) & 
      call derivs(tScaling, szh, A_localtr3, A_localti3, &
       xt, yt, z2t, pxt, pyt, pz2t, &
       dxt, dyt, dz2t, dpxt, dpyt, dpz2t, &
       dadz_r1, dadz_i1)  
