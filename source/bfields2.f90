...
contains
  ...
  subroutine getBFields_T(sx, sy, sZ, &
                        bxj, byj, bzj)
...
!   at a given zbar
  ...
  call getBXfieldT(sx, sy, sz, bxj)
  call getBYfieldT(sx, sy, sz, byj)
  call getBZfieldT(sx, sy, sz, bzj)

end subroutine getBFields_T
...
subroutine getBXfieldT(sx, sy, sz, bxj)
...
! !$OMP END WORKSHARE
  ...
  end subroutine getBXfieldT



  subroutine getBYfieldT(sx, sy, sz, byj)
...
! !$OMP END WORKSHARE
  ...
  end subroutine getBYfieldT




subroutine getBZfieldT(sx, sy, sz, bzj)
