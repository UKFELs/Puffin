...
!1000 call Error_log('Error in BCIOWrapper:CString',tErrorLog_G)
   !Print*,'Error in BCIOWrapper:CString'
2000 CONTINUE
!	      
...
!1000 call Error_log('Error in BCIOWrapper:C_OpenFileForOutput',tErrorLog_G)
   !Print*,'Error in BCIOWrapper:C_OpenFileForOutput'
2000 CONTINUE
!	      
...
!1000 call Error_log('Error in BCIOWrapper:C_WriteInteger',tErrorLog_G)
   !Print*,'Error in BCIOWrapper:C_WriteInteger'
2000 CONTINUE
!	      
      END SUBROUTINE C_WriteInteger
!--------------------------------------------------------------------------------

      SUBROUTINE C_WriteIntegerL(zFileName,        &
                                iNum,            &
			        qOK)
!
!********************************************************************
...
!1000 call Error_log('Error in BCIOWrapper:C_WriteReal',tErrorLog_G)
  ! Print*,'Error in BCIOWrapper:C_WriteReal'
2000 CONTINUE
!	      
...
!--------------------------------------------------------------------------------
      ...
      SUBROUTINE C_WriteString(zFileName,        &
                             zString,           &
			     qOK,               &
			     qNewLine )
!
...
!1000 call Error_log('Error in BCIOWrapper:C_WriteString',tErrorLog_G)
   !Print*,'Error in BCIOWrapper:C_WriteString'
2000 CONTINUE
!	      
