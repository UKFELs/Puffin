...
f.write('! qDump                      Do you wish to dump data so the run can be resumed if anything goes wrong? .TRUE. for yes.\n')
f.write('! qResume                    If resuming from dump files left from a previous run\n')
f.write('! qSeparateFiles             Write data to separate SDDS files at each step\n')
f.write('! qFormattedFiles            Write data as formatted text(TRUE) or binary(FALSE)\n')
f.write('! qWriteZ                    (SDDS only) Write out Z data\n')
f.write('! qWriteA                    (SDDS only) Write out A data\n')
f.write('! qWritePperp                (SDDS only) Write out Pperp data\n')
f.write('! qWriteP2                   (SDDS only) Write out P2 data\n')
f.write('! qWriteZ2                   (SDDS only) Write out Z2 data\n')
f.write('! qWriteX                    (SDDS only) Write out X data\n')
f.write('! qWriteY                    (SDDS only) Write out Y data\n')
f.write('! qsdds                      If .true., write SDDS files\n')
f.write('! qhdf5                      If .true., write HDF5 files\n')
