...
The runInfo group contains information about how the job was called, which version of Puffin was used, the compiler used etc, as well as the scaling constants used in the simulation. Info about the particular point when the data was written, such as the integration step number, point in the machine etc are stored as attributes of the data itself.
...
Puffin comes bundled with a few python scripts to plot the various data. (TODO)
