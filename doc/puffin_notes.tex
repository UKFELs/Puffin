...
At a minimum, one must specify 2 files for use in Puffin - a `main' input file, and a `beam' input file. The main input file describes the system scaling and reference frame, the numerical field mesh, and other numerical integration options, and the beam file describes the electron beam.
